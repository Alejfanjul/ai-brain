# Saúde - Perda de Gordura + Força + Cardio

> **Meta:** Perder 4-6kg de gordura mantendo força. Ficar forte, definido, cardio em dia. Não ficar com aparência de "magrelo fraco".
...
**Composição:** Base muscular boa (ombros, peito, braços), camada de gordura abdominal escondendo definição.

---

## Metodologia: Wendler 5/3/1

**Template:** Prep and Fat Loss Training (do livro 5/3/1 Forever)
...
- Jim Wendler - 5/3/1 Powerlifting
...
**Academia (6:00-7:15):** Completa

**Home Gym:**
- Barra olímpica 20kg + 80kg anilhas
- Dumbbells de concreto
- Gaiola com pull-up bar
- Wall ball (peso masculino)
- Colete 10kg
- Foam roller + lacrosse ball + banda elástica

---

## Alimentação

**Abordagem:** Déficit moderado (300-500 kcal)

**Diretrizes:**
- Proteína: 1.6-2.2g/kg (130-180g/dia)
- Não cortar demais (suportar o trabalho)
- Carboidrato antes do treino garantido

**Dieta que funcionou no passado:**
- Comida de verdade (um dia esteve viva)
- 4 refeições/dia
- Cada: 1 punho proteína + 1 punho carb + 1 colher gordura
- Vegetais fibrosos ilimitados
...
**Status:** Melhorando significativamente

**Rotina de recuperação (10-15 min/dia):**
1. Lacrosse ball (3-5 min) — deitar, pressionar pontos, 30-60s cada
2. Alongamento trap/levator (3-4 min) — 2x 45-60s
3. Band pull-aparts (3 min) — 3x15-20
4. Mobilidade cervical (2 min) — rotações + chin tucks
...
**Próximo treino:** Deadlift (S3)
**Depois:** Cardio → Bench (S3)
...
- Contexto exportado da Claude Web (18/01/2026)
- Livros Wendler disponíveis no projeto
- App: Five3One (Android)
