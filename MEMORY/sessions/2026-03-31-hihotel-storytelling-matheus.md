...
**Para:** Ale e Matheus lerem juntos
**Data:** 2026-03-31
...
Na conversa de 21 de março, algo mudou. O Ale trouxe uma provocação inspirada no Pokémon GO: a Niantic usou o jogo pra capturar dados 3D de cidades inteiras, sem ninguém perceber. O jogo era o cavalo de Tróia. Os dados eram o produto real.
...
A ideia: o SID não é um ERP. É uma plataforma onde o funcionário **aprende**, é **avaliado**, é **reconhecido** e se **desenvolve**. Gamificação, quizzes de onboarding (ideia da Stella), pontos por bom atendimento, benefícios dados pela HiHotel — não pelo hotel. O funcionário é leal à plataforma. Muda de hotel, continua no SID. Um LinkedIn da hotelaria operacional.
...
Em 26 de março, o Duke não tinha respondido em mais de duas semanas com informações básicas pra proposta. O Matheus quase pediu demissão no dia 25, o Ale no dia 26. Convergência independente — os dois chegando no mesmo ponto por caminhos diferentes.
...
O Ale preferiu a segunda. Porque além de criar algo pra vender, o processo de construção já é processo de construção da empresa — praticar produto, praticar conversa com cliente, ter algo tangível.

Aí o Matheus levantou um ponto crucial: **o receio de virar um apanhado de módulos que não conversam.** Software da década passada, peças remendadas. Receio legítimo.

---

## A peça que faltava: ontologia

O Ale pesquisou sobre a Palantir e encontrou o conceito de ontologia — uma camada de significado que fica entre os dados e as interfaces.

A Palantir não construiu "módulos". Ela construiu uma representação unificada do mundo real — objetos (equipamentos, pessoas, transações), relações entre eles, e ações possíveis. Qualquer app que roda em cima da Palantir está falando com o mesmo modelo da realidade. Não importa se é um analista militar ou um gerente de logística.
...
E isso resolve o receio do Matheus de forma técnica e elegante: a gente **lança** o app do restaurante como porta de entrada, mas ele não é isolado. Ele é a primeira janela do ecossistema. Quando o hotel vê que as avaliações do restaurante já alimentam o perfil do garçom, que as preferências do hóspede já são capturadas... ele percebe que não é um app de restaurante. É um pedaço de algo maior.
...
Repara: nenhum desses é verbo de software. Não tem "automatizar", "otimizar", "digitalizar". São verbos de gente. Verbos de liderança e educação. A tecnologia é invisível.
...
**Extrair a ontologia do que já existe.** O SID e o Concierge já foram construídos. O modelo está implícito no código — entidades, relações, ações. A ideia é ler os dois repositórios e gerar um primeiro rascunho da ontologia hoteleira: quais objetos existem, como se conectam, que ações acontecem entre eles. Não como documento final, mas como ponto de partida pra gente olhar junto e dizer "isso faz sentido, isso não, falta isso."

A partir desse rascunho, a gente tem a base pra construir qualquer interface — app do restaurante, Claude Vault, Concierge, o que vier — sabendo que tudo conversa com o mesmo modelo.
