...
- **URL Video:** https://www.youtube.com/watch?v=QqCAuUC7Ypg
- **URL Blog:** https://danielmiessler.com/blog/progressive-web-scraping-four-tier-system
- **Duração:** 11 min
...
![Four-Tier Web Scraping System](images/2025-12-10-web-scraping-tiers/01-four-tier-system-diagram.png)
...
### Resumo do Sistema (4 Tiers)

| Tier | Nome | Tempo | Cobertura | Custo |
|------|------|-------|-----------|-------|
| **1** | WebFetch | ~2-5s | 60-70% | Free |
| **2** | cURL + Headers | ~3-7s | +20-30% | Free |
| **3** | Browser Automation (Playwright) | ~10-20s | +10-15% | Free |
| **4** | BrightData MCP | ~5-15s | 95%+ | ~$0.001-0.01/req |
...
### Tier 4: BrightData MCP

**Ferramentas disponíveis:**
- `scrape_as_markdown` - Single URL extraction
- `scrape_batch` - Multiple URLs (até 10)
- `search_engine` - Google, Bing, Yandex results
- `search_engine_batch` - Multiple search queries

**Infraestrutura:**
- 150M+ residential proxy IPs
- 195 países
...
1. **Japanese e-commerce** - Acessar Amazon Japan
2. **Cyber security investigation** - Investigar infraestrutura de atacantes anonimamente
3. **Bypass Cloudflare** - Quando reverse proxies bloqueiam acesso legítimo

### Custo Real

> "Last few days I've used it. **31 cents**. And that is a whole lot of requests."

**Skill disponível em:** `PAI repo → claude/skills/brightdata`
